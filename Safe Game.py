...
# map keypad characters (from bomb_configs.keypad_keys) to the grid index of
# their corresponding sprite button (row-major in the 4x3 grid).
...
last_pressed = None  # debounce: only register a key on a fresh press (Generated by Claude)
...
while exit_game:
    ...
    # read the matrix keypad (bomb_configs.component_keypad) directly
    if RPi:
